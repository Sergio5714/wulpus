...
- Added a reproducible `uv` lockfile for the Python GUI dependencies.
...
- Removed the obsolete Conda environment file and standalone Python dependency installation guide.
